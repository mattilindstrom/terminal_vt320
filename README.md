...
# Installation
## Konsole
1. Save `VT320Amber.colorscheme` in:
	- ~/.local/share/konsole/ (user-local) or
	- /usr/share/konsole/ (system-wide)
2. Restart or reopen Konsole.
3. In Settings → Edit Current Profile → Appearance, select VT320 Amber.
## WezTerm
Merge with your existing `~/.wezterm.lua`.
